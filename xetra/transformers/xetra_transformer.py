...
class XetraSourceConfig(NamedTuple):
    ...
    src_col_time: columnn name for time in source
...
class XetraTargetConfig(NamedTuple):
    ...
    trg_col_date: column name for the date in target
    ...
    trg_col_dail_trad_vol: column name for the daily traded volume in target
    trg_col_ch_prev_clos: column name for change to previous day's closing price in target
    trg_key: basic key of target file
    trg_key_date_format: date format of target key file
    ...
    class XetraETL():
        ...
        def __init__(self, s3_bucket_src: S3BucketConnector,
            ...
            :params s3_bucket_src: connection to the source S3 bucket
            :params s3_bucket_trg: connection to the target S3 bucket
